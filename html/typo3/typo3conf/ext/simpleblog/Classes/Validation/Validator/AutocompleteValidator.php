<?php
namespace Blog\Simpleblog\Validation\Validator;
class AutocompleteValidator extends \TYPO3\CMS\Extbase\Validation\Validator\AbstractValidator
{
    /**
     * API Service
     *
     * @var \Blog\Simpleblog\Service\GoogleAutocompleteApiService
     */
    ...
    /**
     * @param \Blog\Simpleblog\Service\GoogleAutocompleteApiService $googleAutocompleteApiService
     */
    public function injectGoogleAutocompleteApiService(\Blog\Simpleblog\Service\GoogleAutocompleteApiService $googleAutocompleteApiService)
    {
